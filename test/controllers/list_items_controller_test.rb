...
class ListItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create list_item" do
    assert_difference('ListItem.count') do
      post list_items_url, params: { list_item: { goodreads_book_id: @list_item.goodreads_book_id, list: @list_item.list } }
    end
  ...
  test "should update list_item" do
    patch list_item_url(@list_item), params: { list_item: { goodreads_book_id: @list_item.goodreads_book_id, list: @list_item.list } }
